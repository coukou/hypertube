 ...
 * @final
 */
proto.hypertube.auth.InternalAuthServiceClient =
 ...
 * @final
 */
proto.hypertube.auth.InternalAuthServicePromiseClient =
    function(hostname, credentials, options) {
  if (!options) options = {};
  options['format'] = 'text';

  /**
   * @private @const {!proto.hypertube.auth.InternalAuthServiceClient} The delegate callback based client
   */
  this.delegateClient_ = new proto.hypertube.auth.InternalAuthServiceClient(
 ...
 */
const methodInfo_InternalAuthService_TokenIsValid = new grpc.web.AbstractClientBase.MethodInfo(
  proto.hypertube.auth.TokenValidResponse,
 ...
 */
proto.hypertube.auth.InternalAuthServiceClient.prototype.tokenIsValid =
 ...
 *     The XHR Node Readable Stream
 */
proto.hypertube.auth.InternalAuthServicePromiseClient.prototype.tokenIsValid =
