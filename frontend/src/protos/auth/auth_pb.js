...
goog.exportSymbol('proto.hypertube.auth.EditPasswordRequest', null, global);
 ...
 * @constructor
 */
proto.hypertube.auth.EditPasswordRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.hypertube.auth.EditPasswordRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.hypertube.auth.EditPasswordRequest.displayName = 'proto.hypertube.auth.EditPasswordRequest';
}
 ...
 * @return {!Object}
 */
proto.hypertube.auth.EditPasswordRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.hypertube.auth.EditPasswordRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.hypertube.auth.EditPasswordRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hypertube.auth.EditPasswordRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    password: jspb.Message.getFieldWithDefault(msg, 1, ""),
    password2: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.hypertube.auth.EditPasswordRequest}
 */
proto.hypertube.auth.EditPasswordRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.hypertube.auth.EditPasswordRequest;
  return proto.hypertube.auth.EditPasswordRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.hypertube.auth.EditPasswordRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.hypertube.auth.EditPasswordRequest}
 */
proto.hypertube.auth.EditPasswordRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.hypertube.auth.EditPasswordRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.hypertube.auth.EditPasswordRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.hypertube.auth.EditPasswordRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hypertube.auth.EditPasswordRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPassword();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.hypertube.auth.EditPasswordRequest.prototype.getPassword = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.hypertube.auth.EditPasswordRequest.prototype.setPassword = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.hypertube.auth.EditPasswordRequest.prototype.getPassword2 = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.hypertube.auth.EditPasswordRequest.prototype.setPassword2 = function(value) {
  jspb.Message.setField(this, 2, value);
};
